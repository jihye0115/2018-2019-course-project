...
void main()
{
	...
	while (clock < duration) {
		...
		if (service_time1 > 0 && service_time2 > 0) {// the customer is receiving service
			service_time1--; service_time2--;
		}

		else if (service_time1 > 0 && service_time2 == 0) {
			service_time1--; service_time2 = remove_customer2();
		}
		
		else if (service_time1 == 0 && service_time2 > 0) {
			service_time2--; service_time1 = remove_customer1();
		}
